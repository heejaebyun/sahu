  ...
  return (
    ...
    >
      ...
      {showConsult && (
        <>
          <div
            onClick={() => consultStatus !== "sending" && setShowConsult(false)}
            style={{
              position: "fixed",
          ...
          >
            {consultStatus === "done" ? (
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                ...
                <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 6 }}>신청이 완료되었습니다</div>
              ...
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                  <div style={{ fontSize: 17, fontWeight: 700 }}>전문가 상담 신청</div>
                  <button
                    onClick={() => setShowConsult(false)}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <textarea
                    ...
                    style={{
                      padding: "14px 16px", fontSize: 15,
                      background: "var(--bg)", border: "1px solid var(--border)",
                      borderRadius: 12, color: "var(--text)", resize: "vertical",
                    }}
                  />
                  <button
                    ...
                    style={{
                      ...
                      background: consultForm.name && consultForm.phone
                        ? "linear-gradient(135deg, var(--accent), var(--accent-hover))"
                        : "var(--surface-hover)",
                  ...
                  >
                    {consultStatus === "sending" ? "전송 중..." : "상담 신청하기 (무료)"}
                  </button>
                  {consultStatus === "error" && (
